...
export default function WalkinRevenuePage() {
  ...
  useEffect(() => {
    const fetchContractRevenue = async () => {
      try {
        ...
        // Fetch monthly data
        const monthlyResponse = await fetchApi("/Report/GetParkingLotWalkinMonthlyRevenues", { cache: 'no-store' });
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold tracking-tight">Doanh Thu Vãng Lai</h1>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        {loading ? (
          ...
          <>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Doanh Thu Vãng Lai Theo Tháng ({new Date().getFullYear()})</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Doanh Thu Vãng Lai Theo Quý ({new Date().getFullYear()})</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart 
            ...
            <Card>
              <CardHeader>
                <CardTitle>Doanh Thu Vãng Lai Theo Bãi Đỗ Xe ({new Date().getFullYear()})</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                  <BarChart 
