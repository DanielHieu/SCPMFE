...
export default function ParkingLotContractRevenueInYear({ year }: { year: number }) {
    ...
    useEffect(() => {
        const fetchContractRevenue = async () => {
            try {
                ...
                // Fetch monthly data
                const monthlyResponse = await fetchApi(`/Report/GetParkingLotContractMonthlyRevenues?year=${year}`, { cache: 'no-store' });
                ...
                console.error("Lỗi khi tải dữ liệu doanh thu hợp đồng:", error);
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="grid grid-cols-1 gap-6">
                <Card className="bg-white shadow-sm border border-gray-100 overflow-hidden">
                    <CardHeader className="bg-gray-50 border-b border-gray-100">
                        <CardTitle className="text-xl font-semibold text-gray-800">Doanh Thu Hợp Đồng ({year})</CardTitle>
                    </CardHeader>
